...
async function refreshStatus() {
  try {
    ...
    ["btnRadio", "btnPlaylist", "btnSpotify", "btnAirplay", "btnOff"].forEach((id) => $(id).classList.remove("active"));
    const srcMap = { radio: "btnRadio", playlist: "btnPlaylist", spotify: "btnSpotify", airplay: "btnAirplay", off: "btnOff" };
...
async function refreshNowPlaying() {
  try {
    ...
    if (d.active_source === "spotify" || d.active_source === "airplay") {
      const isSp = d.active_source === "spotify";
      $("npTitle").textContent = isSp ? "Spotify Connect" : "AirPlay";
      $("npArtist").textContent = isSp ? "🎧" : "📱";
      setCover(isSp ? "🎧" : "📱", false, d.active_source);
...
["btnRadio", "btnPlaylist", "btnSpotify", "btnAirplay", "btnOff"].forEach((id) => {
