#!/usr/bin/env bash
# نصب اختیاری Spotify Connect (librespot) برای جارچی
# بعد از نصب: در اپ اسپاتیفای گوشی، دستگاه "Jarchi" را انتخاب کنید
# و در پنل، منبع را روی Spotify بگذارید. (نیازمند Spotify Premium)
set -euo pipefail
