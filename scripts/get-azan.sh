...
#
# چرا این اذان؟ ضبط ۱۳۳۴ رادیو ایران، ثبت‌شده به‌عنوان میراث معنوی
# ملی، و دهه‌هاست آزادانه از صداوسیما و مساجد پخش عمومی می‌شود؛
# برای پخش در ایران عملاً بدون دغدغه است. (مشاوره حقوقی نیست)
set -euo pipefail
